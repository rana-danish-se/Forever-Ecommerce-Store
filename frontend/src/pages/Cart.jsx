...
const Cart = () => {
  const { token, products, currency, navigate, cartItems, updateQuantity } =
      ...
      <div>
        {cartData.map((item, index) => {
          ...
          return (
            <div
              key={index}
              className="py-4 border-t border-b text-gray-700 grid grid-cols-[4fr_0.5gr.0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4"
            >
